...
DATA_DIR = os.path.join(_DATA_ROOT, "roasts")
CAMERA_CONFIG_PATH = os.path.join(_DATA_ROOT, "camera_config.json")
BEAN_PROFILES_PATH = os.path.join(_DATA_ROOT, "bean_profiles.json")
